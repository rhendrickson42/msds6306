...
# merge data
# MergedDataset <- mergeRows(y2015, y2016, common.only=FALSE)
# MergedDataset2 <- mergeRows(y2015, y2016, common.only=TRUE)

# make sure no NAs
# sapply(MergedDataset2, function(x) sum(is.na(x)))
